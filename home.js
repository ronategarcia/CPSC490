...
const buttonsColor = document.querySelectorAll('.choose-color span');
...
// font sizes for the whole page
const rmSizeSelector = () =>{
...
// Buttons colors
const rmActiveOnClick = () => {
    buttonsColor.forEach(colorPicker => {
